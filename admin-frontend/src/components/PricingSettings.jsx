...
export const PricingSettings = () => {
  ...
  return (
    <form
      onSubmit={handleSave}
      className="bg-white rounded-2xl border border-[#E2E2E2] p-8 space-y-8 max-w-4xl"
    >
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#E2E2E2] pb-6">
        <div>
          ...
          <p className="text-sm text-[#6B6B6B] mt-1">
            Configure per-page rates for automated price calculation on customer
            orders.
          </p>
        </div>
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="relative w-36">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleFieldChange("bwA4Single", e.target.value)
                  }
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="relative w-36">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleFieldChange("bwA4Double", e.target.value)
                  }
                  className="w-full h-12 pl-8 pr-4 bg-white border border-[#E2E2E2] rounded-xl text-base font-bold text-[#111111] focus:outline-none focus:border-[#111111]"
                />
              </div>
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="relative w-36">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleFieldChange("colorA4Single", e.target.value)
                  }
                  className="w-full h-12 pl-8 pr-4 bg-white border border-[#E2E2E2] rounded-xl text-base font-bold text-[#111111] focus:outline-none focus:border-[#111111]"
                />
              </div>
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="relative w-36">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleFieldChange("colorA4Double", e.target.value)
                  }
                  className="w-full h-12 pl-8 pr-4 bg-white border border-[#E2E2E2] rounded-xl text-base font-bold text-[#111111] focus:outline-none focus:border-[#111111]"
                />
              </div>
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="relative w-36">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleFieldChange("bwA3Single", e.target.value)
                  }
                  className="w-full h-12 pl-8 pr-4 bg-white border border-[#E2E2E2] rounded-xl text-base font-bold text-[#111111] focus:outline-none focus:border-[#111111]"
                />
              </div>
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="relative w-36">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleFieldChange("bwA3Double", e.target.value)
                  }
                  className="w-full h-12 pl-8 pr-4 bg-white border border-[#E2E2E2] rounded-xl text-base font-bold text-[#111111] focus:outline-none focus:border-[#111111]"
                />
              </div>
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="relative w-36">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleFieldChange("colorA3Single", e.target.value)
                  }
                  className="w-full h-12 pl-8 pr-4 bg-white border border-[#E2E2E2] rounded-xl text-base font-bold text-[#111111] focus:outline-none focus:border-[#111111]"
                />
              </div>
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="relative w-36">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleFieldChange("colorA3Double", e.target.value)
                  }
                  className="w-full h-12 pl-8 pr-4 bg-white border border-[#E2E2E2] rounded-xl text-base font-bold text-[#111111] focus:outline-none focus:border-[#111111]"
                />
              </div>
