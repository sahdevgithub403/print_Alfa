    ...
    <div className="space-y-8 max-w-4xl">
      ...
      <div className="bg-white rounded-2xl border border-[#E2E2E2] p-8 space-y-6">
        <div className="border-b border-[#E2E2E2] pb-4">
          ...
          <p className="text-sm text-[#6B6B6B] mt-0.5">Basic details about your print shop establishment</p>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-sm">
          <div className="space-y-2">
            <label className="text-[#6B6B6B] font-semibold block text-xs uppercase">Shop Name</label>
            <input
              type="text"
              readOnly
          ...
          <div className="space-y-2">
            <label className="text-[#6B6B6B] font-semibold block text-xs uppercase">Shop Slug Identifier</label>
            <input
              type="text"
              readOnly
          ...
          <div className="space-y-2">
            <label className="text-[#6B6B6B] font-semibold block text-xs uppercase">Admin Account Email</label>
          ...
          <div className="space-y-2">
            <label className="text-[#6B6B6B] font-semibold block text-xs uppercase">Account Role</label>
            <div className="relative">
      ...
      <div className="bg-white rounded-2xl border border-[#E2E2E2] p-8 space-y-6">
        <div className="border-b border-[#E2E2E2] pb-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-[#6B6B6B] mt-0.5">Automatic direct printing background agent connection</p>
          </div>
        ...
        <div className="bg-neutral-50 p-6 rounded-xl border border-[#E2E2E2] text-sm space-y-3">
          <div className="flex justify-between border-b border-neutral-200 pb-3">
            ...
            <span className="font-bold text-emerald-800">Online & Polling Queue</span>
          </div>
          <div className="flex justify-between border-b border-neutral-200 pb-3">
            <span className="text-[#6B6B6B]">Queue API Endpoint:</span>
            <span className="font-mono font-bold text-[#111111]">/api/print-agent/jobs</span>
          </div>
          <div className="flex justify-between">
            <span className="text-[#6B6B6B]">Default Connected Printer:</span>
            <span className="font-bold text-[#111111]">HP LaserJet Pro M404n</span>
          </div>
        </div>

        <p className="text-sm text-[#6B6B6B]">
          When direct printing is active, incoming print requests marked as "Print Now" will automatically route to the shop's default thermal or LaserJet printer without prompting browser print windows.
        </p>
      </div>
    </div>
  );
